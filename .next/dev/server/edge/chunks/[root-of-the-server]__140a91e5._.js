...
function middleware(request) {
    ...
    if (request.method === 'POST' && request.nextUrl.pathname === '/') {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/', request.url), 303);
    }
    const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
    // Permite que o Bitrix coloque seu site dentro dele (Iframe)
    response.headers.delete('x-frame-options');
    response.headers.set('Content-Security-Policy', "frame-ancestors 'self' https://*.bitrix24.com.br https://*.bitrix24.com https://*.bitrix24.eu");
    return response;
}
const config = {
    matcher: '/:path*'

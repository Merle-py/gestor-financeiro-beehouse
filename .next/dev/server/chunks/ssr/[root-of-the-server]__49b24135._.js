    ...
    async function fetchAllData() {
        ...
        try {
            const [transRes, suppRes, catRes, recurRes, salesRes] = await Promise.all([
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('sales').select('*').order('created_at', {
                    ascending: false
                })
            ]);
    ...
    async function handleSave() {
        ...
        try {
            if (modalType === 'transaction') {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('sales').insert([
                    payload
                ]);
                ...
                if (editingItem) {
                    const { data: linked } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('*').eq('recurring_rule_id', editingItem.id).eq('status', 'Aberto');
                    if (linked?.length) {
                        const updates = linked.map((t)=>{
                            let newDate = t.due_date;
                            if (parseInt(formData.day_of_month) !== editingItem.day_of_month) {
                                const curr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseISO"])(t.due_date);
                                let d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$setDate$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDate"])(curr, parseInt(formData.day_of_month));
                                if (d.getMonth() !== curr.getMonth()) d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$lastDayOfMonth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["lastDayOfMonth"])(curr);
                                newDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(d, 'yyyy-MM-dd');
                            }
                            return {
                                ...t,
                        ...
                        await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('transactions').upsert(updates);
                    }
                }
            } else {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                modalType === 'transaction' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "date",
                                                    className: "w-full border p-2 rounded",

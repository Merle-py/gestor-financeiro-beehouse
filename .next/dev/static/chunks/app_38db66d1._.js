...
function GestorFinanceiro() {
    ...
    const getDaysText = (dateStr)=>{
        const diff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarDays$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["differenceInCalendarDays"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(dateStr), new Date());
    ...
    const financialMetrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GestorFinanceiro.useMemo[financialMetrics]": ()=>{
            const data = transactions.filter({
                "GestorFinanceiro.useMemo[financialMetrics].data": (t)=>{
                    ...
                    if (filters.startDate && filters.endDate) {
                        ...
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(date) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isWithinInterval$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWithinInterval"])(date, {
            ...
            const receitaBruta = data.filter({
                "GestorFinanceiro.useMemo[financialMetrics].receitaBruta": (t)=>t.type === 'receita'
            }["GestorFinanceiro.useMemo[financialMetrics].receitaBruta"]).reduce({
                "GestorFinanceiro.useMemo[financialMetrics].receitaBruta": (acc, t)=>acc + t.amount
            }["GestorFinanceiro.useMemo[financialMetrics].receitaBruta"], 0);
            const custosVariaveis = data.filter({
                "GestorFinanceiro.useMemo[financialMetrics].custosVariaveis": (t)=>t.type === 'despesa' && t.sale_id
            }["GestorFinanceiro.useMemo[financialMetrics].custosVariaveis"]).reduce({
                "GestorFinanceiro.useMemo[financialMetrics].custosVariaveis": (acc, t)=>acc + t.amount
            }["GestorFinanceiro.useMemo[financialMetrics].custosVariaveis"], 0);
            const despesasFixas = data.filter({
                ...
                "GestorFinanceiro.useMemo[financialMetrics].despesasFixas": (acc, t)=>acc + t.amount
                            ...
                            children: [
                                modalType === 'transaction' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                    children: [
                                        ...
                                        formData.type_trans === 'receita' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                            ...
                                                            children: "Data de Recebimento (Baixa)"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/page.js",
                                                            lineNumber: 454,
                                                            columnNumber: 34
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            ...
                                                            children: "*Preencher isso marca a conta como Paga."
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/page.js",
                                                            lineNumber: 454,
                                                            columnNumber: 324
